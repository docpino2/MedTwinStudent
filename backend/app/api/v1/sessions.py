...
def database_error_response(error: SQLAlchemyError) -> HTTPException:
    return HTTPException(
        status_code=500,
        detail={
            "mensaje": "No se pudo completar la operación longitudinal en la base de datos.",
...
def start_learning_session(
    ...
    try:
        ...
        raise database_error_response(error) from error
